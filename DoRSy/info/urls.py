...
urlpatterns = [
    ...
    path('teacher/<slug:teach_id>/t_viewcourse/', views.t_viewcourse, name='t_viewcourse'),
    ...
    path('teacher/<str:course_id>/<str:teach_id>/t_recent_coursestream/', views.t_recent_course_stream, name='t_recent_course_stream'),
